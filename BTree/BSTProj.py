...
def eliminar(l, codPais = None, pais = None, ano = None, val = None):
    l.remover(codPais, pais, ano, val)

def procurar(l, codPais = None, pais = None, ano = None, val = None):
    ls = []
...
def editar(l, codPais = None, pais = None, ano = None, val = None, ncodPais = None, npais = None, nano = None, nval = None):
...
def main():
    ...
    l = readCsv('dados.csv', l)

    print('\t\t\t*******Antes***********')
    #print('\t\t\t1.º procurar')
    procurar(l, codPais='PRY')
    print('\t\t\t*******************')
    eliminar(l, pais='Paraguay', ano=2010)
    #print('\t\t\t2.º procurar')
    print('\t\t\t***********Depois*********')
    procurar(l, codPais='PRY')
    print('*******************')
